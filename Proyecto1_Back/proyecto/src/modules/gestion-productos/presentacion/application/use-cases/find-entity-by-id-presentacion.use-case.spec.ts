...
import { FindEntityByIdPresentacionUseCase } from './find-entity-by-id-presentacion.use-case';
...
describe('FindEntityByIdPresentacionUseCase', () => {
  let useCase: FindEntityByIdPresentacionUseCase;
  ...
  beforeEach(async () => {
    ...
    useCase = module.get(FindEntityByIdPresentacionUseCase);
  });
  ...
  it('retorna la entidad cuando existe', async () => {
    ...
    expect(result).toBe(presentacion);
  });
