...
export class ProductoDtoMapper {
  static toResponseDto(domainProducto: Producto): ProductoDto {
    return {
      ...
      presentacion: domainProducto.getPresentacion()
                                  ? PresentacionDtoMapper.toReferenciaDto(domainProducto.getPresentacion()!)
                                  : null,
      ...
      denominacionEditadaManualmente: domainProducto.getDenominacionEditadaManualmente(),
    };
  }
