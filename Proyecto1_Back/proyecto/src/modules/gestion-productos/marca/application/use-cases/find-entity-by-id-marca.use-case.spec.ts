...
import { FindEntityByIdMarcaUseCase } from './find-entity-by-id-marca.use-case';
import { IMarcaRepository, MARCA_REPOSITORY_TOKEN } from '../../domain/interfaces/marca.repository.interface';
import { Marca } from '../../domain/entities/marca.entity';

describe('FindEntityByIdMarcaUseCase', () => {
  let useCase: FindEntityByIdMarcaUseCase;
  ...
  beforeEach(async () => {
    ...
    useCase = module.get(FindEntityByIdMarcaUseCase);
  });
